                ...
                <div class="collapse navbar-collapse" id="edicaMainNav">
                    <ul class="navbar-nav mx-auto mt-2 mt-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="blogDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Все лоты</a>
    ...
    <footer class="edica-footer" data-aos="fade-up">
        <div class="container">
            ...
            <div class="footer-bottom-content">
                ...
                <p class="mb-0">© NeSegment. 2023 <a href="https://nesegment" target="_blank" rel="noopener noreferrer" class="text-reset">bootstrapdash</a> . All rights reserved.</p>
            </div>
        </div>
    </footer>
